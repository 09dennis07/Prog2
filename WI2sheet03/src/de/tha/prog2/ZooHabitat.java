...
public class ZooHabitat {
	...
	public void addAnimal(Animal a) throws HabitatFullException, InvalidAnimalException {
		...
		} else if (animals.size() != 0 && a.getClass() != animals.get(0).getClass()) {  // funktioniert nicht mehr sobald es mehrere Tierarten als Klassen gibt wie z.B. Tiger und Löwe als Carnivore bes[...]
